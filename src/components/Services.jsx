...
const Services = () => {
  return (
    ...
    <div className='md:-mt-28 bg-gradient-to-bl flex items-center justify-center from-sky-950 via-gray-900 to-sky-950'>
      ...
      <div className='min-h-64 min-w-40 hover:shadow-2xl hover:scale-110 hover:rounded-2xl transition-all ease-in-out delay-400 duration-500 hover:bg-[#263B57]'>
            ...
            <p className='text-left text-gray-400 text-xs mt-4'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ipsam, quo dolore adipisci ipsum doloribus voluptatem est cum inventore ipsa? Voluptatum, veniam veritatis modi alias fugiat ad eligendi dolore autem iure.</p>
            </motion.div>
      </div>
         <div className='min-h-64 min-w-40 hover:shadow-2xl hover:scale-110 hover:rounded-2xl transition-all ease-in-out delay-400 duration-500 hover:bg-[#263B57]'>
            <motion.div className='m-8' 
